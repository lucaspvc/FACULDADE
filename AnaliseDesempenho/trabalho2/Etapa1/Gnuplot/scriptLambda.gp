...
set key right inside top font ",19" box linestyle 5
...
plot "./Dados/Coleta60.txt" using 1:5 with lines linestyle 1 title "Ocupação a 60%", \
     "./Dados/Coleta80.txt" using 1:5 with lines linestyle 2 title "Ocupação a 80%", \
...
# Gerar o gráfico em SVG
set terminal svg size 1000,800
set output './Graficos/lambda_tempo_corte.svg'
